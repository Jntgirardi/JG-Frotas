...
class Caminhao:
    def __init__(self, id=None, placa=None, modelo=None, ano=None, cor=None, status='Disponível'):
        self.id = id
        self.placa = placa
        self.modelo = modelo
        self.ano = ano
...
class Viagem:
    ...
    def calcular_lucro(self):
        self.lucro_liquido = self.valor_frete - (self.custo_combustivel + self.custo_pedagio + self.outros_custos)
